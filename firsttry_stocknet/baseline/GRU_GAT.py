...
if __name__ == "__main__":
    ...
    plt.legend()
    plt.show()
    plt.savefig('/root/firsttry-main/firsttry_stocknet/baseline/GRU+GAT.png')
    ...
    plt.ylabel('value')
    plt.legend()
    plt.savefig('/root/firsttry-main/firsttry_stocknet/baseline/GRU+GAT_testing_real_forecast.png')

# test mse_loss: 0.025973861835089075
# test mae_loss: 0.1607297271729473
# test rmse_loss: 0.16115501151984954
# test mape_loss: 31.961014766769715
# gru+gat_IC: -0.00987352273264381
# gru+gat_RankIC: -0.011010577259278707
# gru+gat_ICIR: -0.8017229521633727
# gru+gat_RankICIR: -1.3461863600495804e-06