...
# 使用最优超参数
beta = 2.2154989182063934e-07
theta = 3.2713468911939044e-09
epochs = 31
...
## 获取股票数据 
folder_path = '/root/firsttry-main/firsttry-main-stocknet/preprocessed_price_stocknet/'
...
# 获取结构邻接矩阵
correlation_path="/root/firsttry-main/firsttry-main-stocknet/data/topology_matrix_stocknet.csv"
