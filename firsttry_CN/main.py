...
# # 先打乱数据顺序
# np.random.seed(42)
# np.random.shuffle(batch_data_list)

# # 计算划分索引
# train_size = int(0.6 * len(batch_data_list))
# val_size = int(0.2 * len(batch_data_list))

# # 进行划分
# train_data = batch_data_list[:train_size]   # 60% 训练集
# val_data = batch_data_list[train_size:train_size + val_size]  # 20% 验证集
# test_data = batch_data_list[train_size + val_size:]  # 20% 测试集
...
0.0016717712492209102,0.028145659239574645,0.03835825052616807,9.384984945257505,0.8938509613107701,0.7746959477223846,21.963436086733104,3.90812543430299e-05