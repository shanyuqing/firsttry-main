...
if __name__ == "__main__":
    ...
    plt.legend()
    plt.show()
    plt.savefig('/root/firsttry-main/firsttry_CN/baseline/LSTM.png')
    ...
    plt.ylabel('value')
    plt.legend()
    plt.savefig('/root/firsttry-main/firsttry_CN/baseline/LSTM_testing_real_forecast.png')

# test mse_loss: 0.0012431438137430935
# test mae_loss: 0.02458602580736624
# test rmse_loss: 0.032763146606157534
# test mape_loss: 7.894363938520352
# lstm_IC: 0.8834911061179116
# lstm_RankIC: 0.7599353529258337
# lstm_ICIR: 29.297421791084414
# lstm_RankICIR: 3.830703907117564e-05