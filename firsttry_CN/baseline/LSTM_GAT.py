...
if __name__ == "__main__":
    ...
    plt.legend()
    plt.show()
    plt.savefig('/root/firsttry-main/firsttry_CN/baseline/LSTM+GAT.png')
    ...
    plt.ylabel('value')
    plt.legend()
    plt.savefig('/root/firsttry-main/firsttry_CN/baseline/LSTM+GAT_testing_real_forecast.png')

# test mse_loss: 0.0016680868408608756
# test mae_loss: 0.0318292960873805
# test rmse_loss: 0.03942116801044904
# test mape_loss: 11.125950701534748
# lstm+gat_IC: 0.43178906253468496
# lstm+gat_RankIC: 0.4365163501357323
# lstm+gat_ICIR: 10.91605036972542
# lstm+gat_RankICIR: 2.1976634111395643e-05