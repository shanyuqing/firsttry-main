...
if __name__ == "__main__":
    ...
    plt.legend()
    plt.show()
    plt.savefig('/root/firsttry-main/firsttry_CN/baseline/RNN.png')
    ...
    plt.ylabel('value')
    plt.legend()
    plt.savefig('/root/firsttry-main/firsttry_CN/baseline/RNN_testing_real_forecast.png')

# test mse_loss: 0.0012913084231058747
# test mae_loss: 0.027529681979406934
# test rmse_loss: 0.0341881007431463
# test mape_loss: 9.136164343605438
# rnn_IC: 0.7272248874674228
# rnn_RankIC: 0.5886980608410228
# rnn_ICIR: 25.419808789603614
# rnn_RankICIR: 2.96573573442839e-05